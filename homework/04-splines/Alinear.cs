...
{
    //I like to have the class store its own data, I do not really need for linear interpolation, but I think it is nice
    private class lspline
    {
        private double[] xdata;
        private double[] ydata;

        //And if I do define the class, I might as well pre-calculate everything
        private double[] a;
        private double[] b;
