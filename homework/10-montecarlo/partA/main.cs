...
public static class main
{
    ...
    public static int Main()
    {
        ...
        WriteLine($"-----------------------------------------------------");
        WriteLine($"plain integral of x*y from 0,0 to 1,1 is {res0}±{err0} "+(approx(res0,0.25,err0,err0) ? " PASS" : " FAIL"));
        WriteLine($"-----------------------------------------------------");
        ...
        WriteLine($"-----------------------------------------------------");
        WriteLine($"plain integral of f(x,y)=1 if x^2+y^2<0^2.8, otherwise 0  from 0,0 to 1,1 is {res2}±{err2} "+(approx(res2,0.5026548245743669   ,err2,err2) ? " PASS" : " FAIL"));
        WriteLine($"-----------------------------------------------------");
        ...
        WriteLine($"AGAIN, plain monte carlo is random and may randomly fail a few times");
        WriteLine($"In my experience it works MORE OFTEN THAN NOT");
